...
class ProductController extends AbstractController
{
    ...
    #[Route('/client/product/{id}', name: 'client_product_show', requirements: ['id' => '\d+'])]
    public function showClient(Product $product): Response
    {
    ...
    /*****admin part */
    #[Route('/admin/product/count', name: 'admin_product_count')]
    public function countProducts(ProductRepository $productRepository): Response
    {
        $productCount = $productRepository->count([]);

        return $this->render('admin/product/count.html.twig', [
